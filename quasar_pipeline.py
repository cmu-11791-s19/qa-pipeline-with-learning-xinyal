...
class Pipeline(object):
    def __init__(self, retrievalInstance,
                 featurizerInstance, classifierInstance,
                 trainFilePath="./quasar-s_train_formatted.json",
                 valFilePath="./quasar-s_dev_formatted.json"):
...
if __name__ == '__main__':
    ...
    print("evaluating Multinomial Naive Bayes with COUNT features..")
    ...
    print (trainInstance.question_answering())

    print("evaluating Multi-layer Perceptron with COUNT features..")
    classifierInstance = MLPClassifier()
    trainInstance = Pipeline(trainFilePath, valFilePath, retrievalInstance, featurizerInstance, classifierInstance)
    print(trainInstance.question_answering())

    print("evaluating SVM with COUNT features..")
    ...
    print("evaluating Multinomial Naive Bayes with tf-idf features..")
    classifierInstance = MultinomialNaiveBayes()
    trainInstance = Pipeline(trainFilePath, valFilePath, retrievalInstance, featurizerInstance, classifierInstance)
    print(trainInstance.question_answering())

    print("evaluating Multi-layer Perceptron with tf-idf features..")
    classifierInstance = MLPClassifier()
    trainInstance = Pipeline(trainFilePath, valFilePath, retrievalInstance, featurizerInstance, classifierInstance)
    print(trainInstance.question_answering())

    print("evaluating SVM with tf-idf features..")
    classifierInstance = SvmClassifier()
    trainInstance = Pipeline(trainFilePath, valFilePath, retrievalInstance, featurizerInstance, classifierInstance)
    print(trainInstance.question_answering())

    # TODO: make a table from the 6 groups of output
